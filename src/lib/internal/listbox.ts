// Shared dropdown-panel + option-row recipes for the listbox-style controls (Select and Combobox), defined once so the
// two stay visually identical — the sibling of MENU_PANEL_BASE/MENU_ITEM_BASE for the menu parts. Internal — not
