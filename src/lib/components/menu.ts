// The compound `Menu` namespace. Re-exports the parts so consumers write `Menu.Root`, `Menu.Item`, `Menu.Separator`, …
// — the convention Bits itself uses (`export * as DropdownMenu`). The barrel re-exports this as `export * as Menu`, so
// `import { Menu } from "@qovira/ui"` carries the lot.
