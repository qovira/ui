...
<Avatar.Root
  ...
  class={cn(
    "relative inline-flex shrink-0 select-none items-center justify-center overflow-hidden rounded-full border border-divider bg-surface-raised font-sans font-medium text-fg",
    SIZE[size],
    klass,
  )}
>
